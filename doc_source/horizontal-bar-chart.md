...
| --- | --- | --- | --- | 
| Changing the legend display | Yes, with exceptions | Multi\-measure horizontal bar charts and clustered horizontal bar charts display a legend, while single\-measure horizontal bar charts do not\. | [Customizing the Visual Legend](formatting-a-visual.md#customizing-visual-legend) | 
