# Amazon QuickSight Calculated Field Function and Operator Reference<a name="calculated-field-reference"></a>
...
+ [parseJson](parseJson-function.md) parses values from a JSON object in a text field\.
